...
skip_read:
    ...
    *wont_need = LF_ISSET(WT_READ_WONT_NEED) ||
    ...
    if (LF_ISSET(WT_READ_INTERNAL_OP))
        printf("Internal operation when reading the page. Make sure to pass it to __wt_evict_touch_page via __wt_ref_make_visible\n");
